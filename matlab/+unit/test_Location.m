classdef test_Location < mlunit.test_case
  ...
  methods
    ...
    function test_obj = test_Location(varargin)
      test_obj = test_obj@mlunit.test_case(varargin{:});
      test_obj.testObj = cws.Location();
    end
    
    % Public Unit Tests
    function self = test_01_create( self )
      mlunit.assert(isa(self.testObj,'cws.Location'));
    end
