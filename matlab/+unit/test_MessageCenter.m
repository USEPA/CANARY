classdef test_MessageCenter < mlunit.test_case
  ...
  methods
    ...
    function test_obj = test_MessageCenter(varargin)
      test_obj = test_obj@mlunit.test_case(varargin{:});
      test_obj.testObj = cws.MessageCenter();
    end
    
    % Public Unit Tests
    function self = test_01_create( self )
      mlunit.assert(isa(self.testObj,'cws.MessageCenter'));
    end
